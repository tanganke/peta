...
TemplateFunc: TypeAlias = Callable[[str], str]
TemplateFuncList: TypeAlias = List[TemplateFunc]

cars_template: TemplateFuncList = [
...
cifar10_template: TemplateFuncList = [
    lambda c: f"a photo of a {c}.",
...
cifar100_template: TemplateFuncList = [
    lambda c: f"a photo of a {c}.",
    lambda c: f"a blurry photo of a {c}.",
    lambda c: f"a black and white photo of a {c}.",
    lambda c: f"a low contrast photo of a {c}.",
...
eurosat_template: TemplateFuncList = [
...
food101_template: TemplateFuncList = [
    lambda c: f"a photo of {c}, a type of food.",
]

gtsrb_template: TemplateFuncList = [
...
mnist_template: TemplateFuncList = [
    lambda c: f'a photo of the number: "{c}".',
]

imagenet_template: TemplateFuncList = [
    lambda c: f"a bad photo of a {c}.",
...
resisc45_template: TemplateFuncList = [
...
stl10_template: TemplateFuncList = [
    lambda c: f"a photo of a {c}.",
    lambda c: f"a photo of the {c}.",
]

sun397_template: TemplateFuncList = [
    lambda c: f"a photo of a {c}.",
    lambda c: f"a photo of the {c}.",
]

svhn_template: TemplateFuncList = [
    lambda c: f'a photo of the number: "{c}".',
]
...
def get_templates(dataset_name: str) -> List[TemplateFunc]:
    R"""
    return a list of template functions. And each template function accept a class name as input, returns a sentence.
    """
